{ inputs, config, pkgs, ... }: {
  ...
  # TODO: Setup snapcast?
  # A guy's config: https://github.com/sweenu/nixfiles/blob/main/hosts/grunfeld/snapserver.nix
  # official guide: https://nixos.wiki/wiki/Snapcast
  # Nice explanation: https://erenon.hu/posts/2022-02-21-snapcast-on-demand/

  ## SSL
  ## TODO: Needed for snapcast or not?
  # security.acme = {
